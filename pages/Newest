      ...
      <div style={{
        ...
        <div style={{
          ...
          {[
            ...
            { key: 'ai-notes', icon: '🤖', label: 'AI Notes' }
          ].map(tab => (
            <button
              key={tab.key}
              ...
              style={{
                ...
                border: 'none',
                borderBottom: activeTab === tab.key ? '3px solid #764ba2' : '3px solid transparent',
                cursor: 'pointer',
                fontSize: '14px',
          ...
          <div>
            ...
            <div style={{ 
              ...
              <div style={{
                ...
                <h3 style={{ color: '#667eea', margin: '0 0 10px 0' }}>🛡️ HIPAA Status</h3>
